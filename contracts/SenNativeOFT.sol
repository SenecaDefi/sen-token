...
import "./token/oft/v1/NativeOFT.sol";
...
contract SenTokenNativeOFT is NativeOFT {
    ...
    constructor(address lzEndpoint, address uniRouter) NativeOFT('tester', 'TEST', lzEndpoint)  {
